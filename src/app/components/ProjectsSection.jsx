...
const projectsData = [
  ...
  },
  {
    ...
    title: "Anime",
    description:
      "The website is built with Next.js, a React framework for creating fast and dynamic web pages The website also uses Framer Motion, a library for animating React components, and Shikimori.one API, a service that provides anime and manga data. The website does not have any other function other than displaying anime titles, which are sorted by popularity, rating, or name. The website has a simple and minimalist design, with a dark background and colorful anime posters. The website is responsive and works well on different devices and screen sizes. The website is hosted on Vercel, a platform for deploying and scaling web applications",
  ...
  },
  {
    ...
    title: "Climate card ",
    description:
      "Climate Card React Site is a website that showcases how to create a simple weather app using React and OpenWeatherMap API. To create beautiful and responsive weather cards that display the current and forecasted weather data for different cities. You can learn how to fetch the data from the API, use environment variables, and use React hooks to manage the state of the app. You can also see the source code and a live demo of the app on the website1. If you are interested in learning React and building a weather app, this website is a great resource for you.",
